...
$sql .="SELECT SNo from classes JOIN students ON students.Class=classes.Name WHERE IDNo='$vo'";
...
if($to==0)
{
      echo "<br>"."<div align='center'>"."<font color='orange' size='4'>"."<b>"."Invalid Username"."</b>"."</font>"."</div>";
header("Refresh: 1;signup");
}
$conn->close();
...
$sqll = "SELECT IDNo FROM Namelist ";
