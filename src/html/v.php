...
$sql .="SELECT SNo from classes JOIN students ON students.Class=classes.Name WHERE IDNo='$so'";
if($so==''||$soo=='')
{
echo "<br>"."<div align='center'>"."<font color='orange' size='4'>"."<b>"."Invalid Username or Password"."</b>"."</font>"."</div>";
...
$sqll = "SELECT IDNo,Password FROM Namelist ";
$resultt = $connn->query($sqll);
...
{
while($rowwww= $resultt->fetch_assoc()) {
  if(strcmp($rowwww["IDNo"],$so)==0 && strcmp($rowwww["Password"],$soo)==0){
